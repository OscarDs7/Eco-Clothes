...
<body>
    ...
    <section>
        ...
        <h1 style="text-align:center" class="subtitulo">Listado de productos Deportivos</h1>
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                        ...
                        $cas = new Deportiva();
                        $datos = $cas->consultaProductosDeportivos();
                    
                        while($fila = mysqli_fetch_array($datos)){
                            echo "<tr><td>".$fila['nombre']."</td><td>".$fila['precio']."</td>
                            <td>".$fila['descripcion']."</td><td>".$fila['categoria']."</td><td>
