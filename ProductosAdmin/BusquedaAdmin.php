...
<body>
    ...
    <section>
        <h1 class="busqueda">Busqueda de producto</h1>
        <div class="buscar">
        <form method="post" action="../Controlador/procesaMovimientoProducto.php">
            <div class="formleyenda"><label>Id:</label></div>
            <input id="idproducto" type="text" name="idproducto" onfocus="entroEnFoco(this);" onblur="salioDeFoco(this); validarNombre(this)">
            <div></div>
            <div>
                <button id="enviarConsultaProd" name="enviarConsultaProd" type="submit">Buscar</button>
            </div>
        </form>
        </div>
