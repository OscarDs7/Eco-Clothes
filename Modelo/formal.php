...
class Formal{
    ...
    public function RegistrarProductoFormal(){
        ...
        $registrar = "insert into productos (idProducto, nombre, precio,  descripcion, categoria, imagen, tiporopa) Values ('".NULL."','".$this->getNombre()."','".$this->getPrecio()."','".$this->getDescripcion()."','".$this->getCategoria()."','".$this->getImagen()."',3)";
        //echo $registrar."<br>";
    ...
    public function consultaProductoFormal(){
        //1-Definir la instruccion SQL de consulta
        //select * from alumnos order by apellidos;
        $consulta = "select nombre, precio,  descripcion, categoria, tiporopa, imagen from productos where tiporopa = 3 and nombre LIKE '".$this->getNombre()."';";
        //echo $consulta."<br>";
    ...
    public function consultaProductosFormal(){
        //1-Definir la instruccion SQL de consulta
        //select * from alumnos order by apellidos;
        $consulta = "select nombre, precio, descripcion, categoria, imagen from productos where tiporopa = 3 order by nombre";
