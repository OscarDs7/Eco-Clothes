...
class Deportiva{
    ...
    public function RegistrarProductoDeportivo(){
        ...
        $registrar = "insert into productos (idProducto, nombre, precio, descripcion, categoria, imagen, tiporopa) Values ('".NULL."','".$this->getNombre()."','".$this->getPrecio()."','".$this->getDescripcion()."','".$this->getCategoria()."','".$this->getImagen()."',2)";
        //echo $registrar."<br>";
    ...
    public function consultaProductoDeportivo(){
        //1-Definir la instruccion SQL de consulta
        //select * from alumnos order by apellidos;
        $consulta = "select nombre, precio, descripcion, categoria, tiporopa, imagen from productos where tiporopa = 2 and nombre LIKE '".$this->getNombre()."';";
        //echo $consulta."<br>";
    ...
    public function consultaProductosDeportivos(){
        //1-Definir la instruccion SQL de consulta
        //select * from alumnos order by apellidos;
        $consulta = "select nombre, precio, descripcion, categoria, imagen from productos where tiporopa = 2 order by nombre";
